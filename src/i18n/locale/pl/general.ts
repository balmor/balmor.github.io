...
export const general: General = {
  ...
  practices.`,
  thirdMeDescription: `My front-end build process involves the use of tools such as React,
  Webpack and NPM to speed up development.`,
  fourthMeDescription: `I have a working knowledge of popular UI frameworks like Material UI and Bootstrap using Styled Components and know my way around version management and working in Scrum,
  ...
  webDevelopmentDescription: `Tworzę stron internetowych uywająć HTML5, CSS3 i JavaScript (Typescript) z preprocesorem Sass lub korzysgtajac z React + styled-compoenents.`,
